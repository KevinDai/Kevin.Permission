...
namespace Kevin.Permission.Domain.Core
{
    ...
    public interface ICommonPermissionService
    {
        ...
        /// <param name="user">用户</param>
        /// <param name="accessObject">访问对象</param>
        /// <param name="operation">操作列表</param>
        /// <returns>是否拥有权限</returns>
        bool HaveAllPermission(User user, AccessObject accessObject, IEnumerable<Operation> operation);
        ...
        /// <param name="operation">操作列表</param>
        /// <returns>是否拥有权限</returns>
        bool HaveAnyPermission(User user, AccessObject accessObject, IEnumerable<Operation> operation);
